...
<html lang =eng>
    ...
    <body>
	        <?php
    if (isset($_POST['mot_de_passe']) AND $_POST['mot_de_passe'] ==  "mer")
    {
    ?>
            ...
            <div class="content clearfix">
                ...
                <div>
                    ...
                    <p> Veuillez remplir ce questionnaire :
                        <a href="https://forms.gle/jhGoZdhpSL9QtE77A" onclick="open('https://forms.gle/jhGoZdhpSL9QtE77A' , 'Popup', 'scrollbars=1,resizable=1,height=560,width=770'); return false;">ici</a>
                    </p>
                		<div class="container">
<center> </br>
        <p>CODE :</p>
