...
<html lang =eng>
    ...
    <body>
	        <?php
    if (isset($_POST['mot_de_passe']) AND $_POST['mot_de_passe'] ==  "4100")
    {
    ?>
            ...
            <div class="content clearfix">
                ...
                <div>
                    ...
                    <p> Veuillez remplir ce questionnaire :
                        <a href="https://forms.gle/8TU9HUmGszMf3nuy7" onclick="open('https://forms.gle/8TU9HUmGszMf3nuy7' , 'Popup', 'scrollbars=1,resizable=1,height=560,width=770'); return false;">ici</a>
                    </p>
                		<div class="container">
<center> </br>
        <p>CODE :</p>
