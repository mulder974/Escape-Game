...
<html lang =eng>
    ...
    <body>
	        <?php
    if (isset($_POST['mot_de_passe']) AND $_POST['mot_de_passe'] ==  "courant")
    {
    ?>
            ...
            <div class="content clearfix">
                ...
                <div>
                    ...
                    <p> Veuillez remplir ce questionnaire :
                        <a href="https://forms.gle/v9TXtZQLdDCzWpEi8" onclick="open('https://forms.gle/v9TXtZQLdDCzWpEi8' , 'Popup', 'scrollbars=1,resizable=1,height=560,width=770'); return false;">ici</a>
                    </p>
                		<div class="container">
<center> </br>
        <p>CODE :</p>
